...
urlpatterns = [
    ...
    path('clientes/<int:cliente_id>/correccion/solicitar/', views.solicitar_correccion_cliente, name='solicitar_correccion_cliente'),
    path('clientes/correcciones/', views.solicitudes_correccion_cliente, name='solicitudes_correccion_cliente'),
    path('clientes/correcciones/<int:solicitud_id>/resolver/', views.resolver_correccion_cliente, name='resolver_correccion_cliente'),
